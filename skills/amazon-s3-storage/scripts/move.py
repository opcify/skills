...
"""Move (rename) an object within an Amazon S3 bucket."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Move/rename an object in S3.")
    ...
    try:
        ...
        result = {"from": src_key, "to": dst_key, "bucket": bucket, "fetched_at": now_iso()}
