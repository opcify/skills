...
"""Generate a pre-signed download URL for a Cloudflare R2 object."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Generate a pre-signed URL for an R2 object.")
    ...
    try:
        ...
        pub = public_url(key)
        if pub:
            print(f"Public URL (permanent): {pub}")
